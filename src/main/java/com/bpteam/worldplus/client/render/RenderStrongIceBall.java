...
public class RenderStrongIceBall extends Render<EntityStrongIceBall> {
    ...
    public static final ResourceLocation TEXTURES = new ResourceLocation(WorldPlus.MODID + ":textures/items/stronger_ice_ball.png");
    ...
    @Override
    public void doRender(EntityStrongIceBall entity, double x, double y, double z, float entityYaw, float partialTicks) {
        {
            GlStateManager.pushMatrix();
            this.bindEntityTexture(entity);
            GlStateManager.translate((float) x, (float) y, (float) z);
            GlStateManager.enableRescaleNormal();
            TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(ModItems.STRONGER_ICE_BALL);
