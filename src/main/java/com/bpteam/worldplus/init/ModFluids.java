...
public class ModFluids extends Fluid
{
    ...
    public ModFluids setAlpha(float parOverlayAlpha)
    {
    ...
    @Override
    public ModFluids setEmptySound(SoundEvent parSound)
    {
        emptySound = parSound;
        return this;
    }
    ...
    @Override
    public ModFluids setFillSound(SoundEvent parSound)
    {
        fillSound = parSound;
        return this;
    }
    ...
    public ModFluids setMaterial(Material parMaterial)
    {
